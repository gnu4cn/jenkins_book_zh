...
- [通过 Blue Ocean](#通过-Blue-Ocean) -- 在 Blue Ocean 中设置管道项目后，Blue Ocean UI 可帮助咱们编写管道的 Jenkinsfile 并将其提交到源代码管理；

- [通过经典 UI](#通过经典-UI) —— 咱们可通过经典 UI 直接在 Jenkins 中进入一个基本的 Pipeline；
